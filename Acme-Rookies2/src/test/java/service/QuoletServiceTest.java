...
public class QuoletServiceTest extends AbstractTest {
	...
	public void CreatePositionService() {
		final Object testingData[][] = {
			{//Positive test
				"765411-juyt", null, "Body1", "https://www.imagen.com.mx/assets/img/imagen_share.png", 1, super.getEntityId("audit3"), 0, "auditor1", null
			}, {//Negative test: body vacio
				"134531-juyt", null, "", "https://www.imagen.com.mx/assets/img/imagen_share.png", 1, super.getEntityId("audit3"), 0, "auditor1", ConstraintViolationException.class
			},
